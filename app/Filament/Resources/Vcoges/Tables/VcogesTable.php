        ...
        return $table
            ->columns([
                ...
                TextColumn::make('storno_entrata')
                    ...
                    ->summarize(Sum::make()->money('EUR')->label(''))
                    ->sortable()
                    ->url(fn($record) => ProvvigioneResource::getUrl('attive') . '?tableFilters[status_compenso][values][0]=Pratica+stornata&tableFilters[mese_status][value]=&tableFilters[erogated_at][has_erogated_date]=all&tableFilters[mese_erogazione][value]=' . substr($record->mese, -2))
                ...
                TextColumn::make('storno_uscita')
                    ...
                    ->label('Storno Uscita')
                    ->sortable()
                    ->url(fn($record) => ProvvigioneResource::getUrl('index') . '?tableFilters[status_compenso][values][0]=Pratica+stornata&tableFilters[mese_status][value]=&tableFilters[erogated_at][has_erogated_date]=all&tableFilters[mese_erogazione][value]=' . substr($record->mese, -2))
                    ->openUrlInNewTab(false),
            ])
